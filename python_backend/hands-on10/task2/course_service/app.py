...
This is unchanged from Hands-On 10 / Task 1. In Task 2, Student Service
calls GET /api/courses/{id}/ on this service over HTTP to verify a course
exists before enrolling a student - it never touches courses.db directly.
"""
